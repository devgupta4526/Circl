...
interface ParticipantsScreenParams {
...
const ParticipantsScreen: React.FC = () => {
  ...
  const { participants, activityAccess } = route.params as ParticipantsScreenParams;
          ...
          {participants.length === 0 ? (
            ...
            participants.map((participant) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => {/* Future: Navigate to user profile */}}
              >
                <Image
                  source={{ uri: participant.image || 'https://i.pravatar.cc/100' }}
